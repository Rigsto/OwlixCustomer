            ...
            <div class="col-md-3">
                <div class="card" id="KategoriFilter" style="width: 17rem;">
                    ...
                    <ul class="list-group list-group-flush">
                      ...
                      <a href="http://" class="py-1"><li class="list-group-item border-bottom">{{$item['name']}}</li></a>
                      @endforeach
                    </ul>
                  </div>
            </div>
                        ...
                        <div class="card">
                            <form action="product_detail" style="position: relative" method="GET" >
                               ...
                               <div class="card-body">
                                   ...
                                   <button class="btn h-100" style="background:yellow;" type="submit"> See Product</button>
