            ...
            <div class="col-md-3">
                <div class="card" id="KategoriFilter" style="width: 17rem;">
                    ...
                    <ul class="list-group list-group-flush">
                      <a href="http://" class="py-1"><li class="list-group-item border-bottom">Semua Produk</li></a>
                      <a href="http://" class="py-1"><li class="list-group-item border-bottom">Rumah Tangga</li></a>
                      <a href="http://" class="py-1"><li class="list-group-item border-bottom">Pakaian</li></a>
                      <a href="http://" class="py-1"><li class="list-group-item border-bottom">Kebutuhan Sekolah</li></a>
                      <a href="http://" class="py-1"><li class="list-group-item border-bottom">Makanan</li></a>
                      <a href="http://" class="py-1"><li class="list-group-item border-bottom">Kerajinan Tangan</li></a>
                      <a href="http://" class="py-1"><li class="list-group-item border-bottom">Elektronik</li></a>
                      <a href="http://" class="py-1"><li class="list-group-item">Lainnyaa</li></a>
                    </ul>
                  </div>
            </div>
            <div class="col-md-9">
                <div class="d-flex">
                    ...
                    data-aos-offset="10"
                    data-aos-delay="10"
                    data-aos-duration="1000"><a href="" class="kategori-btn"><img class="rounded-images mw-100" src="assets/img/KebutuhanRT.svg" alt=""></a></div>
                    <div class="ml-sm-3" data-aos="fade-up"
                    data-aos-offset="10"
                    data-aos-delay="20"
                    data-aos-duration="1000"><a href="" class="kategori-btn"><img class="rounded-images mw-100" src="assets/img/Pakaian.svg" alt=""></a></div>
                    <div class="ml-sm-3" data-aos="fade-up"
                    data-aos-offset="10"
                    data-aos-delay="30"
                    data-aos-duration="1000"><a href="" class="kategori-btn"><img class="rounded-images mw-100" src="assets/img/KebutuhanSekolah.svg" alt=""></a></div>
                </div>
                <div>
                    ...
                    <div class="card-deck product-grid justify-content-between py-sm-4">
                        ...
                        <div class="card mr-sm-2">
                            <form action="{{ url('product_detail') }}" style="position: relative">
                            <img class="card-img-top" style="height: 12rem;" src="{{$item['store_item_images'][0]['image_url']}}" alt="Card image cap">
                               <div class="card-body">
                                   ...
                                   <div class="product-price pt-4 d-flex justify-content-between align-items-end">
                                       <p class="text-muted"><del>{{$item['store_item_price']}}</del></p>
                                       <h5>Rp{{ number_format($item['store_item_price'], 0, ',', '.') }}</h5>
                                   </div>
                               </div>
                               <input type="hidden" name="product_id" value="{{ $item['id'] }}">
                               <button class="btn h-100" style="background:transparent;position: absolute; top:0; left:0; right:0; bottom:0;"></button>
                           </div>
                        @endforeach
                     {{-- <div class="card mr-sm-2">
                         <a href="">
