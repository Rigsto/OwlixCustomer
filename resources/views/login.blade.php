...
<body style="background-color: #F7F7F7; background-image: url('/assets/img/LoginBackground.svg'); background-repeat: no-repeat; background-size: contain; background-position-y: bottom; background-attachment: fixed;">
<div class="container py-sm-5">
  <div class="row justify-content-center text-center py-5">
    <div class="col-12 col-md-6 col-lg-4 py-sm-5 px-sm-5"  id="LoginForm">
      <div class="w-100 align-center">
        <img class="w-25"src="assets/img/owlLogo.svg" alt="">
        <h3 class="my-4">Login ke Owlix</h3>
      </div>
      <form class="mb-3 mt-5" form action="login" method="POST">
        @csrf
      ...
      <p class="text-left mb-0 my-3 font-danger">
        @isset($data)
            @if ($data['message'] != null){{ $data['message'] }} @endif
        @endisset
    </p>
